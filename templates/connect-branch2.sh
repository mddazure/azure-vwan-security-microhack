...
az network vpn-connection create -n to-we-hub --vnet-gateway1 vnet-gw-onprem2 -g vwan-security-microhack-spoke-rg --local-gateway2 lng2 -l northeurope --shared-key $sharedkey --enable-bgp
